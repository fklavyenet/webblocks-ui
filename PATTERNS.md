...
7. Focus-above-page interactions belong to the overlay primitive layer, not to page-pattern markup: use `wb-modal` for dialog/decision UI and `wb-overlay` for content-first viewer UI.
