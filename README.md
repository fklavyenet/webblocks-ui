...
- admin index tables should keep an explicit left-aligned `Actions` header and use `wb-table-actions` for the final action column without pushing row actions to the right
