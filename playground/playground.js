  ...
  var EXAMPLES = [
    ...
    },
    {
      ...
      html: [
        ...
        '      <h2 class="wb-auth-header-title">',
        '        <img src="../assets/branding/brand-logo-64.png" alt="" class="wb-auth-brand-mark wb-auth-brand-mark-sm">',
        '        <span>Sign in to WebBlocks UI</span>',
        '      </h2>',
    ...
    },
    {
      ...
      description: 'A canonical breadcrumb example showing the default path, compact variant, and current-page semantics with CSS-generated separators.',
      hint: 'Check the semantic nav and ordered list structure, the link/current split, and how the compact variant only tightens spacing and type.',
      docs: [
        { href: '../docs/pattern-breadcrumb.html', label: 'Breadcrumb', meta: 'Canonical breadcrumb pattern guidance' },
        { href: '../docs/patterns.html', label: 'Patterns', meta: 'Pattern-first page hierarchy guidance' }
      ],
      html: [
        ...
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Pages</a></li>',
        '      <li class="wb-breadcrumb-item"><span class="wb-breadcrumb-current" aria-current="page">Home</span></li>',
        '    </ol>',
        '  </nav>',
        '  <nav class="wb-breadcrumb wb-breadcrumb-compact" aria-label="Compact breadcrumb">',
        '    <ol class="wb-breadcrumb-list">',
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Pages</a></li>',
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Home</a></li>',
        '      <li class="wb-breadcrumb-item"><span class="wb-breadcrumb-current" aria-current="page">Blocks</span></li>',
        '    </ol>',
        '  </nav>',
        '  <nav class="wb-breadcrumb" aria-label="Long breadcrumb">',
        '    <ol class="wb-breadcrumb-list">',
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Dashboard</a></li>',
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Knowledge base</a></li>',
        '      <li class="wb-breadcrumb-item"><a class="wb-breadcrumb-link" href="#">Editorial operations and governance guides</a></li>',
        '      <li class="wb-breadcrumb-item"><span class="wb-breadcrumb-current" aria-current="page">Reviewing homepage hero content for multilingual releases</span></li>',
        '    </ol>',
        '  </nav>',
        '</div>'
      ].join('\n')
    ...
    },
    {
      ...
      html: [
        ...
        '          <li class="wb-breadcrumb-item"><span class="wb-breadcrumb-current" aria-current="page">Deployments</span></li>',
        '        </ol>',
        '      </nav>',
        '      <div>',
